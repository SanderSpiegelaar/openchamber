...
export const dict: Record<I18nKey, string> = {
  ...
  "header.session.rename": "Перейменувати сесію",
  "header.session.renameSave": "Зберегти назву сесії",
  "header.session.renameCancel": "Скасувати перейменування сесії",
  ...
  "commandPalette.item.renameActiveSession": "Перейменувати активну сесію",
