...
export const dict = {
  ...
  'header.session.rename': 'Rename session',
  'header.session.renameSave': 'Save session name',
  'header.session.renameCancel': 'Cancel renaming session',
  ...
  'commandPalette.item.renameActiveSession': 'Rename Active Session',
