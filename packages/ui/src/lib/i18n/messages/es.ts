...
export const dict: Record<I18nKey, string> = {
  ...
  "header.session.rename": "Renombrar sesión",
  "header.session.renameSave": "Guardar nombre de sesión",
  "header.session.renameCancel": "Cancelar cambio de nombre de sesión",
  ...
  "commandPalette.item.renameActiveSession": "Renombrar sesión activa",
